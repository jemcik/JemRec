...
public final class AudioEncoder implements AsyncProcessor {
    ...
    /**
     * PATCHED: takes its three settings directly instead of an Options object.
     * See ../../../../../PATCHES.md.
     *
     * Upstream this was AudioEncoder(capture, streamer, Options), and it read
     * exactly three values out of that Options: the bit rate, the codec options
     * and the encoder name. Options itself is 707 lines of command-line parsing
     * that also references the video, camera, display and orientation types, so
     * keeping it would have dragged roughly half of scrcpy back in to supply
     * three fields. This fork has no command line to parse.
     *
     * @param codecOptions may be null
     * @param encoderName  null to let MediaCodec pick the default encoder
     */
    ...
    private static MediaCodec createMediaCodec(Codec codec, String encoderName) throws IOException, ConfigurationException {
        if (encoderName != null) {
            ...
            try {
                ...
                // PATCHED: upstream appended LogUtils.buildAudioEncoderListMessage()
                // here. LogUtils is 299 lines that reach into Device, DisplayInfo,
                // VideoCodec, DeviceApp and DisplayManager to build a listing, for
                // a message on a path this fork never takes - it always passes a
                // null encoderName. See ../../../../../PATCHES.md.
        ...
        try {
            ...
            // PATCHED: LogUtils listing dropped, as above.
